<!-- NAME - BARSHA CHETRI -->
<!-- EMAIL - barshachetri19@gmail.com -->
...
<html lang="en">
  <head>
    ...
    <title>Welcome to Basic Banking System</title>
	...
	<style>
	  ...
	  h2{font-family: "Lucida Handwriting",cursive;}
    </style>
  </head>
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1">
              <div class="col-sm-8 col-md img text-left">
                <img src="img/bank.jpg" class="float-left">
              </div>
			  
              <div class="col-sm-16 col-md">
